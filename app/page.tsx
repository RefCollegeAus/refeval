...
export default function Home() {
  ...
  const {
    ...
    login, logout: authLogout, selectOrganisation,
          ...
          <section className="panel">
            ...
            <div className="analytics-card" style={{ marginTop: 16 }}>
              ...
              <div className="metric-grid">
                <div className="metric-tile"><div className="number">{members.length}</div><div className="hint">Total members</div></div>
                <div className="metric-tile"><div className="number">{refereeMembers.length}</div><div className="hint">Referees</div></div>
                <div className="metric-tile"><div className="number">{educatorMembers.length}</div><div className="hint">Educators</div></div>
                <div className="metric-tile"><div className="number">{adminMembers.length}</div><div className="hint">Admins</div></div>
                <div className="metric-tile"><div className="number">{superAdminMembers.length}</div><div className="hint">Super Admins</div></div>
              </div>
              <div className="metric-grid" style={{ marginTop: 8 }}>
                <div className="metric-tile"><div className="number">{orgReviews.length}</div><div className="hint">Evaluations</div></div>
                <div className="metric-tile"><div className="number">{orgReviews.filter(r => r.status === "Completed").length}</div><div className="hint">Completed</div></div>
                <div className="metric-tile"><div className="number">{orgReviews.filter(r => r.status !== "Completed").length}</div><div className="hint">Outstanding</div></div>
              </div>
            </div>
