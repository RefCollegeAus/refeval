...
export default function Home() {
  ...
  const [videoZoomPct, setVideoZoomPct]   = useState(100);
  const videoResizeDragRef = useRef<{ startY: number; startH: number } | null>(null);
