...
import { resolveClipBounds, formatClipTime } from "@/lib/utils/clipBounds";
...
export default function Home() {
  ...
  function resetDrafts() {
    setDraftRefereeTarget("All Referees"); setDraftExtraOfficials([]); setDraftOutcome(""); setDraftCategoryGroup(""); setDraftSpecificTag(""); setDraftCategory(""); setDraftPosition(""); setDraftCoverage(""); setDraftNotes(""); setDraftIsLearningClip(false); setDraftEndSeconds(null); setCodingError("");
  }
  ...
  async function saveVideoCode() {
    ...
    if (!draftPosition) { setWizardStep(2); setCodingError("Please select a Position."); return; }
    if (!draftCoverage) { setWizardStep(3); setCodingError("Please select a Coverage area."); return; }
