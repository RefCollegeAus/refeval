...
</p><div className="action-row" style={{marginTop:20}}><button onClick={()=>setConfirmDiscardReview(false)}>Cancel</button><button className="danger" onClick={cancelReview}>{isNewReview?"Yes, Discard":"Yes, Leave"}</button></div></div></div>}{globalSearchOverlay}</main>;
}
